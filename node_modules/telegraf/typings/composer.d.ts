...
declare type Getter<U extends tt.Update, P extends string> = PropOr<GetUpdateContent<U>, P, undefined>;
/**
 ...
 */
export declare type NarrowedContext<C extends Context, U extends tt.Update> = C & {
...
export declare class Composer<C extends Context> implements MiddlewareObj<C> {
     ...
     */
    guard<U extends tt.Update>(guardFn: (update: tt.Update) => update is U, ...fns: NonemptyReadonlyArray<Middleware<NarrowedContext<C, U>>>): this;
    /**
     ...
     */
    command(command: MaybeArray<string>, ...fns: MatchedMiddleware<C, 'text'>): this;
    /**
    ...
    private entity;
    email(email: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
    url(url: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
    textLink(link: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
    textMention(mention: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
    mention(mention: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
    phone(number: MaybeArray<string>, ...fns: MatchedMiddleware<C>): this;
     ...
     */
    start(...fns: ReadonlyArray<Middleware<C & {
        startPayload: string;
    }>>): this;
    /**
     * Registers a middleware for handling /help
     */
    help(...fns: NonemptyReadonlyArray<Middleware<C>>): this;
    /**
     * Registers a middleware for handling /settings
     */
    settings(...fns: NonemptyReadonlyArray<Middleware<C>>): this;
     ...
     */
    static guard<C extends Context, U extends tt.Update>(guardFn: (u: tt.Update) => u is U, ...fns: NonemptyReadonlyArray<Middleware<NarrowedContext<C, U>>>): MiddlewareFn<C>;
    /**
    ...
    static email<C extends Context>(email: MaybeArray<string>, ...fns: MatchedMiddleware<C>): MiddlewareFn<C>;
    static phone<C extends Context>(number: MaybeArray<string>, ...fns: MatchedMiddleware<C>): MiddlewareFn<C>;
    static url<C extends Context>(url: MaybeArray<string>, ...fns: MatchedMiddleware<C>): MiddlewareFn<C>;
    static textLink<C extends Context>(link: MaybeArray<string>, ...fns: MatchedMiddleware<C>): MiddlewareFn<C>;
    static textMention<C extends Context>(mention: MaybeArray<string>, ...fns: MatchedMiddleware<C>): MiddlewareFn<C>;
     ...
     */
    static command<C extends Context>(command: MaybeArray<string>, ...fns: MatchedMiddleware<C, 'text'>): MiddlewareFn<C>;
    /**
     ...
     */
    static chatType<C extends Context>(type: MaybeArray<tt.ChatType>, ...fns: NonemptyReadonlyArray<Middleware<C>>): MiddlewareFn<C>;
    /**
